...
- [ ] **advancedMetrics — insights i18n:** migrar `generateAdvancedInsights()` em `advancedMetrics.ts` (15 insights hardcoded PT) + `calculations.ts` (2 insights hardcoded PT) para chaves i18n — pendente.
- [ ] **teamAnalysis — insights i18n:** migrar insights hardcoded PT em `teamAnalysis.ts` (análise de equipas + cobertura) para chaves i18n — pendente.

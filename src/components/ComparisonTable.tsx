        ...
        <div className="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden mt-8">
            ...
            <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                    <thead>
                        <tr>
                            <th className="p-4 bg-gray-900/50 text-gray-400 font-medium border-b border-gray-700 w-1/4">Metric</th>
                    ...
                    <tbody>
                        <tr>
                            <td className="p-4 border-b border-gray-700 text-gray-300">Avg Weekly Hours</td>
                        ...
                        <tr>
                            <td className="p-4 border-b border-gray-700 text-gray-300">Total Annual Hours</td>
                            {analyses.map((analysis, i) => (
                        ...
                        <tr>
                            <td className="p-4 border-b border-gray-700 text-gray-300">Weekends Off (Year)</td>
                            {analyses.map((analysis, i) => (
                        ...
                        <tr>
                            <td className="p-4 border-b border-gray-700 text-gray-300">Total Off Days (Year)</td>
                            {analyses.map((analysis, i) => (
                        ...
                        <tr>
                            <td className="p-4 border-b border-gray-700 text-gray-300 align-top">Analysis</td>
                            {analyses.map((analysis, i) => (
